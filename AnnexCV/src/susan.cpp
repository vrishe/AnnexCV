...
namespace cv 
{
	...
	void filterSusan(const cv::Mat &src, cv::Mat &dst, unsigned radius, double sigma, double t, int borderType)
	{
	...
	void cornerSusan(const cv::Mat &src, cv::Mat &dst, unsigned radius, double t, double g, int borderType)
	{
